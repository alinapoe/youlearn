...
// La alumna hace click en "Ya reprogramé" después de reservar un nuevo
// horario en el link de la profe. Suma 1 a reschedules_used, bloqueando
// si ya llegó al límite de su pack actual.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Traer el pack actual (más reciente entre portal y manual) + schedule actual
    ...
    if (!upsertRes.ok) {
      ...
      return res.status(500).json({ error: 'No se pudo registrar la reprogramación' });
    }
